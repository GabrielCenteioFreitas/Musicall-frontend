...
export const SmallFavoriteArtistButton = ({ artist, isFavorited, className, size=20 }: SmallFavoriteArtistButtonProps) => {
  ...
  const handleFavoriteArtistClick = async () => {
    ...
    try {
      ...
      console.error("Error fetching iTunes data for artist favorites:", error)
      toast.error("Ocorreu um erro!")
    } finally {
      setIsLoading(false)
    }
